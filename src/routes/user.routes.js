...
router.get(
  "/:id",
  [authjwt.verificarToken, authjwt.isDirector, userMD.userExistenceId],
...
router.put(
  ...
  [
    ...
    authjwt.isDirector,
    userMD.userDuplicateReq,
    userMD.userExistenceId,
  ],
...
router.delete(
  ...
  [
    ...
    authjwt.isDirector,
    userMD.userExistenceId,
    userMD.userSelfDeletion,
  ],
  userController.delete
);
router.put(
  "/asignar/:id",
  [authjwt.verificarToken, authjwt.isDirector, projMD.projExistencebyBody],
